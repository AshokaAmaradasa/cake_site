...
if(isset($_POST['add_to_cart'])){
    ...
    if(isset($_SESSION['cart'])){
       ...
       if( !in_array($_POST['product_id'], $products_array_ids) ){
        ...
        $product_id = (isset($_POST['product_color_id'])) ? $_POST['product_id']."_".$_POST['product_color_id'] : $_POST['product_id'];
        $product_name = $_POST['product_name'];
        $product_price = $_POST['product_color_price'];
        $product_image = $_POST['product_image'];
        $product_quantity = $_POST['product_quantity'];
        $product_size_type = $_POST['product_size_type'];
        $product_size = $_POST['product_size'];
        $product_property_name = $_POST['product_color_name'];
        $product_color_id = $_POST['product_color_id'];
        $product_norm_price = $_POST['product_norm_price'];
        ...
        $product_array = array(
                         ...
                         'product_norm_price' => $product_norm_price,
